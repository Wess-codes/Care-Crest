        ...
        <div className="grid md:grid-cols-3 gap-10">
          {services.map((service, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="mb-2 group-hover:scale-105 transition-transform">{service.icon}</div>
...
<p className="text-sm text-foreground/80 text-center">{service.description}</p>
